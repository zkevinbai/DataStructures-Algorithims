...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.top) {
            ...
            this.minVal = val;
            this.maxVal = val;
            this.top.localMax = this.maxVal;
            this.top.localMin = this.minVal;
        } else {
            const temp = this.top;
            this.top.next = temp;
            if (this.maxVal < val){
    ...
    pop() {
        ...
        this.minVal = this.top.localMin
        this.maxVal = this.top.localMax
        this.length--;
        return temp;
    }
    ...
    min() {
        return (!this.length) ? null : this.minVal
    }

    max() {
        return (!this.length) ? null : this.maxVal
    }
}
